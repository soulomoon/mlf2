...
- [x] 1. Rebind explicit-forall binders under scheme gen in annotated schemes
  ...
  - **Completed:** 4b267aa, 788d58e

- [x] 2. Remove explicit-forall free-name exemption in generalization
...
- [x] 3. Validate bounded-aliasing and full suite
