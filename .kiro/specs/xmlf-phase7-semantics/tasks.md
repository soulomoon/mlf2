...
- [x] 1. Add Phase 7 error types and module scaffolding
  - Steps:
...
- [x] 2. Implement xMLF typechecking rules (Figure 4)
  - Steps:
...
- [x] 3. Implement xMLF reduction semantics (Figure 5)
  - Steps:
...
- [x] 4. Wire Phase 7 into the pipeline and public API
  - Steps:
...
- [x] 5. Add Phase 7 tests and wire them into the suite
  - Steps:
