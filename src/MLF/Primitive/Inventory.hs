  ...
  Map.fromList
    [ ( andPrimitiveName,
      ...
      ( stringReplacePrimitiveName,
        primitiveValueSpec
          PrimitiveNativeStringReplace
          (stringTy `PrimitiveTypeArrow` (stringTy `PrimitiveTypeArrow` (stringTy `PrimitiveTypeArrow` stringTy)))
          Set.empty
      ),
      ( stringIndexOfCharPrimitiveName,
        primitiveValueSpec
      ...
      ( stringFromIntPrimitiveName,
        primitiveValueSpec
          PrimitiveNativeStringFromInt
          (intTy `PrimitiveTypeArrow` stringTy)
          Set.empty
      ),
      ( stringFromBoolPrimitiveName,
        primitiveValueSpec
      ...
      ( stringToListPrimitiveName,
        primitiveValueSpec
          PrimitiveNativeStringToList
          (stringTy `PrimitiveTypeArrow` listOf charTy)
          Set.empty
      ),
      ( stringDropPrimitiveName,
        primitiveValueSpec
...
stringReplacePrimitiveName :: String
stringReplacePrimitiveName =
  "__string_replace"
...
stringSplitPrimitiveName :: String
stringSplitPrimitiveName =
  "__string_split"
...
stringFromIntPrimitiveName :: String
stringFromIntPrimitiveName =
  "__string_from_int"
...
isPrimitiveNativeLowerable =
  \case
    ...
    PrimitiveNativeStringReplace -> True
