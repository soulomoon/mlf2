...
{- |
Module      : MLF.Constraint.Types.Witness.Internal
Description : Internal witness and expansion owners
Copyright   : (c) 2024
License     : BSD-3-Clause

This module owns the raw witness constructors. Production code should prefer
the narrowed façade in "MLF.Constraint.Types.Witness". Tests that need
deliberately malformed fixtures should use the explicit test-support seam.
-}
module MLF.Constraint.Types.Witness.Internal (
    NodeId(..),
    EdgeId(..),
