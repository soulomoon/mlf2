...
- After that corpus exists, target native-capable broad string/`Char` substrate
  ...
  slicing tracer, `stringTake` take slicing tracer, and `stringSlice` range
  slicing tracer are not the complete broad string library; continue
