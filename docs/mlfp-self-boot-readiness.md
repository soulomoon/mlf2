...
- After that corpus exists, target native-capable broad string/`Char` substrate
  ...
  tracer, and `stringContains` substring search tracer are not the complete broad string library; continue adding the Prelude-level
