...
- After that corpus exists, target native-capable broad string/`Char` substrate
  ...
  tracer, and `charIsAsciiPunctuation` explicit ASCII punctuation `Char`
  classification tracer
