...
- After that corpus exists, target native-capable broad string/`Char` substrate
  ...
  literal tracers are not that broad string library; start that later family by adding the
