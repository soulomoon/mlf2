...
- After that corpus exists, target native-capable broad string/`Char` substrate
  ...
  and `charIsAsciiAlphaNum` explicit ASCII alphanumeric `Char` classification
  tracer
