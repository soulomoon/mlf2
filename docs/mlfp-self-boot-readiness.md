...
- After that corpus exists, target native-capable broad string/`Char` substrate
  ...
  `charIsDigit` decimal `Char` classification tracer are not the complete
  broad string library; continue
