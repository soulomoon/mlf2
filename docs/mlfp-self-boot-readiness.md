...
parity, formatting, `String`/`List Char` conversion, or platform/proof
completion.
...
printability categories, locale, regex, parser parity, formatting,
...
it does not claim `String`/`List Char` conversion, formatting, parser parity,
...
claim `String`/`List Char` conversion, formatting, parser parity, platform
