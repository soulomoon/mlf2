...
- After that corpus exists, target native-capable broad string/`Char` substrate
  ...
  slicing tracer, and `stringCharAt` in-range cursor/index tracer are not the
  complete broad string library; continue
