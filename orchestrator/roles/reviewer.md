...
- Reject any manufactured provenance authority, heuristic uniqueness claim, or prototype-backed re-entry claim.
...
- Do not accept rounds that treat prototype-backed evidence as admissible for re-entry or implementation clearance.
