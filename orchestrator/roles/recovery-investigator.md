...
Diagnose delegated-stage failures for the post-rev-004 repo-scope refreshed-
matrix and narrowed-blocker successor loop.
...
- Diagnose stage failures, untrustworthy artifacts, or non-observable
  delegated work for the active repo-scope loop.
