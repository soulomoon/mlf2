...
Rounds `round-001` through `round-090` remain historical predecessor
evidence. Revisioned-roadmap migration may add stable roadmap/state
provenance, but it must not reinterpret accepted stage results into the live
retry schema.
