...
- Preserve current backend architecture: xMLF remains the elaboration IR and
  ...
  resolver.
- Deferred alternatives: primitives-first substrate, driver-first substrate,
  end-to-end vertical seed compiler, and compiler-in-`.mlfp` implementation.
...
- In scope:
  ...
  - readiness evidence for a later compiler-in-`.mlfp` roadmap.
- Out of scope:
