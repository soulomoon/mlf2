...
- The authoritative retry summary matches `review-record.json` exactly:
  ...
  - canonical artifact:
    `docs/plans/2026-03-22-automatic-iso-recursive-base-target-exact-target-bind.md`
- `orchestrator/roadmaps/2026-03-22-00-automatic-iso-recursive-inference-post-l2-successor-roadmap/rev-004/retry-subloop.md` permits merge preparation after
  `accepted + finalize`, and `orchestrator/rounds/round-071/state-snapshot.json` is already at
