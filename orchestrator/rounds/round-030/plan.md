...
- `orchestrator/rounds/round-030/selection.md`
- `orchestrator/roadmaps/2026-03-14-01-unannotated-iso-recursive-inference-successor-roadmap/rev-008/verification.md`
- `orchestrator/roadmaps/2026-03-14-01-unannotated-iso-recursive-inference-successor-roadmap/rev-008/retry-subloop.md`
...
1. `docs/plans/2026-03-17-uri-r2-c1-u3-unannotated-uniqueness-owner-clearance.md`

Optional bounded note file:

1. `orchestrator/rounds/round-030/implementation-notes.md` (only if needed for reviewer clarity)

Files that must remain untouched in this round:

- `orchestrator/rounds/round-030/state-snapshot.json`
- `orchestrator/roadmaps/2026-03-14-01-unannotated-iso-recursive-inference-successor-roadmap/rev-008/roadmap.md`
- `orchestrator/rounds/round-030/selection.md`
- `Bugs.md`
- production/test surfaces under `src/`, `src-public/`, `app/`, `test/`, `mlf2.cabal`
- prior round artifacts under `orchestrator/rounds/round-001/` through `orchestrator/rounds/round-029/`
...
- Write `docs/plans/2026-03-17-uri-r2-c1-u3-unannotated-uniqueness-owner-clearance.md` with:
...
- Run applicable baseline checks from `orchestrator/roadmaps/2026-03-14-01-unannotated-iso-recursive-inference-successor-roadmap/rev-008/verification.md`:
  - `git diff --check`
  - `python3 -m json.tool orchestrator/rounds/round-030/state-snapshot.json >/dev/null`
  - `rg -n '"contract_version": 2|"retry": null|"retry": \{' orchestrator/rounds/round-030/state-snapshot.json`
  - `rg -n '^\d+\. \[(pending|in-progress|done)\]' orchestrator/roadmaps/2026-03-14-01-unannotated-iso-recursive-inference-successor-roadmap/rev-008/roadmap.md`
  ...
  - `test -f orchestrator/roadmaps/2026-03-14-01-unannotated-iso-recursive-inference-successor-roadmap/rev-008/retry-subloop.md`
...
- No edits to `orchestrator/rounds/round-030/state-snapshot.json`, `orchestrator/roadmaps/2026-03-14-01-unannotated-iso-recursive-inference-successor-roadmap/rev-008/roadmap.md`, `Bugs.md`, or prior-round history.
- No second executable interface, compatibility fallback, convenience shim, or default-on widening path.

## Reviewer Checks

Baseline checks from `orchestrator/roadmaps/2026-03-14-01-unannotated-iso-recursive-inference-successor-roadmap/rev-008/verification.md` still apply.
