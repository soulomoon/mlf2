...
- Do not edit `orchestrator/roadmaps/2026-03-14-00-automatic-recursive-type-inference-research-roadmap/rev-004/roadmap.md`.
...
1. Create `docs/plans/2026-03-14-automatic-recursive-inference-ari-c1-feasibility-spike.md`
2. Update `test/PipelineSpec.hs`
3. Create `orchestrator/rounds/round-004/implementation-notes.md`
...
5. Diff is limited to planned files and does not modify `orchestrator/roadmaps/2026-03-14-00-automatic-recursive-type-inference-research-roadmap/rev-004/roadmap.md` or predecessor authoritative logs.

## Reviewer And Verification Checks

Baseline checks (from `orchestrator/roadmaps/2026-03-14-00-automatic-recursive-type-inference-research-roadmap/rev-004/verification.md`):
- `git diff --check`
- `python3 -m json.tool orchestrator/rounds/round-004/state-snapshot.json >/dev/null`
- `rg -n '^\d+\\. \\[(pending|in-progress|done)\\]' orchestrator/roadmaps/2026-03-14-00-automatic-recursive-type-inference-research-roadmap/rev-004/roadmap.md`
...
- Reviewer writes `orchestrator/rounds/round-004/review.md` with:
