...
`/Users/ares/.codex/worktrees/d432/mlf4/.worktrees/round-085/orchestrator/rounds/round-084/review-record.json`
...
shows only controller-owned `M orchestrator/state.json` drift. No repository
