...
- Roadmap Dir: `orchestrator/roadmaps/2026-03-25-00-general-automatic-iso-recursive-inference-strategic-orchestrator-roadmap/rev-002`
- State Snapshot: `orchestrator/rounds/round-083/state-snapshot.json`
...
controller-owned `M orchestrator/rounds/round-083/state-snapshot.json` drift. No repository-state
