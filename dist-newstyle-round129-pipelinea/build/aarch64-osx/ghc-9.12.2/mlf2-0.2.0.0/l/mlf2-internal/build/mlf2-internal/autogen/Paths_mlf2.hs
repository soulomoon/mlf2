...
-- at runtime using the environment variable mlf2_bindir.
...
-- environment variable mlf2_libdir.
...
-- using the environment variable mlf2_dynlibdir.
...
-- runtime using the environment variable mlf2_datadir.
...
-- using the environment variable mlf2_sysconfdir.
...
bindir     = "/Users/ares/.cabal/bin"
libdir     = "/Users/ares/.cabal/lib/aarch64-osx-ghc-9.12.2-ea3d/mlf2-0.2.0.0-inplace-mlf2-internal"
dynlibdir  = "/Users/ares/.cabal/lib/aarch64-osx-ghc-9.12.2-ea3d"
datadir    = "/Users/ares/.cabal/share/aarch64-osx-ghc-9.12.2-ea3d/mlf2-0.2.0.0"
libexecdir = "/Users/ares/.cabal/libexec/aarch64-osx-ghc-9.12.2-ea3d/mlf2-0.2.0.0"
sysconfdir = "/Users/ares/.cabal/etc"

getBinDir     = catchIO (getEnv "mlf2_bindir")     (\_ -> return bindir)
getLibDir     = catchIO (getEnv "mlf2_libdir")     (\_ -> return libdir)
getDynLibDir  = catchIO (getEnv "mlf2_dynlibdir")  (\_ -> return dynlibdir)
getDataDir    = catchIO (getEnv "mlf2_datadir")    (\_ -> return datadir)
getLibexecDir = catchIO (getEnv "mlf2_libexecdir") (\_ -> return libexecdir)
getSysconfDir = catchIO (getEnv "mlf2_sysconfdir") (\_ -> return sysconfdir)
