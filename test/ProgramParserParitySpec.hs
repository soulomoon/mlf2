...
sharedParserRecursiveMethodRowUsePhrases =
    [ "parserBind (parseClassMethodSignatureRow sourceFile ValueUnit)\n        (parseEqClassMethodRowsMoreOrClose sourceFile classStart)"
    , "parserBind (appendProjectionValues existingRows nextRows)\n        (parseEqClassMethodRowsMoreOrClose sourceFile classStart)"
    , "parserBind (parseClassMethodSignatureRow sourceFile ValueUnit)\n          (appendClassMethodRowsAndContinue sourceFile classStart methodRows)"
    , "parserBind (parseInstanceMethodDefinitionRow sourceFile ValueUnit)\n        (parseEqNatInstanceMethodRowsMoreOrClose sourceFile classToken typeValue)"
    , "parserBind (appendProjectionValues existingRows nextRows)\n        (parseEqNatInstanceMethodRowsMoreOrClose sourceFile classToken typeValue)"
    , "parserBind (parseInstanceMethodDefinitionRow sourceFile ValueUnit)\n          (appendInstanceMethodRowsAndContinue sourceFile classToken typeValue methodRows)"
    , "parserBind (expectMethodNameParser ValueUnit)"
